...
def _report_has_quantity_without_source_lineage(
    ...
    *,
    ...
    quantity_value_keys = {
        ...
        "qty_value",
        "estimated_quantity",
        "estimated_quantity_value",
        "estimated_qty",
        "estimated_qty_value",
        "estimate_quantity",
        "estimate_quantity_value",
        "est_quantity",
        "est_quantity_value",
        "quantity_estimate",
        "quantity_estimate_value",
        "qty_estimate",
        "qty_estimate_value",
        "computed_quantity",
        "computed_quantity_value",
        "computed_qty",
        "computed_qty_value",
        "calculated_quantity",
        "calculated_quantity_value",
        "calculated_qty",
        "calculated_qty_value",
        "estimated_takeoff_quantity",
        "estimated_takeoff_quantity_value",
        "estimated_takeoff_qty",
        "estimated_takeoff_qty_value",
        "estimate_qty",
        "estimate_qty_value",
        "est_qty",
        "est_qty_value",
        "computed_takeoff_quantity",
        "computed_takeoff_quantity_value",
        "computed_takeoff_qty",
        "computed_takeoff_qty_value",
        "calculated_takeoff_quantity",
        "calculated_takeoff_quantity_value",
        "calculated_takeoff_qty",
        "calculated_takeoff_qty_value",
        "measured_quantity",
        "measured_qty",
        "measurement",
        "measurement_value",
