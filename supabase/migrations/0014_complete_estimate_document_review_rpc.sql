-- =============================================================================
-- Mobi Estimates — EstimateJob document review completion RPC
--
-- Atomically completes the internal document-review handoff so the job status
-- transition and audit event cannot diverge. Staff-only; client-facing pages do
